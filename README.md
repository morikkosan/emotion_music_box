...
- **自身のSNSアカウントをこっそり活用**
  音楽趣味用のそれぞれのアカウント、X（フォロワー約13,000人他アカウント）やInstagram（約8,500人他アカウント）、youtube（14000人くらい）を持っており、
  音楽を趣味で楽しむ層に向けて、目立たないようこっそり宣伝や共有など、自分にできる範囲で発信していく。
...
- **投稿フローのUX設計（検索 → 投稿フォーム）**
  ...
  - **検索専用ページ**または**ポップアップ画面（モーダルUI）**で、SoundCloud APIを使った**楽曲検索・再生**を行い、好みの曲を選択。再生視聴可能。
...
> 開発者向けのテスト/CI手順は **[docs/TESTING.md](docs/TESTING.md)** を参照してください。
